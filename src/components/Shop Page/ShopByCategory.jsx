          ...
          {categoriesInfo.map((category, index) => (
            ...
            >
              ...
              <div className="w-full text-center text-white flex flex-col items-center h-full justify-center gap-y-6">
                ...
                <button className="bg-primary-900 px-4 py-2 rounded-md w-fit text-base md:text-lg hover:bg-primary-50 transition-all hover:text-primary-950 text-white font-semibold">
                  Shop Now
                </button>
              </div>
            </div>
