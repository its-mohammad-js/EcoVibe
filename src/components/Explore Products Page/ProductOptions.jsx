...
import { getProductOption } from "../../helpers/constants";
...
function ProductOptions({ onSelectOption }) {
  ...
  useEffect(() => {
    ...
    const localoptionList = localStorage.getItem("productsOptions");
    ...
    if (localoptionList) {
      setOptions({
        optionsList: JSON.parse(localoptionList)[0].OptionData,
        loading: false,
        error: "",
      });
    } else {
