...
const cardsData = [
  ...
  },
  {
    ...
    query: "/EcoVibe/Explore-Products/tags=special",
  },
  {
    title: "New Release",
    avatarUrl:
    ...
    query: "/EcoVibe/Explore-Products/tags=new release",
  },
  {
    title: "Best Seller",
    avatarUrl:
    ...
    query: "/EcoVibe/Explore-Products/tags=best sell",
  },
  {
    title: "Top Products",
    avatarUrl:
    ...
    query: "/EcoVibe/Explore-Products/tags=popular",
  },
  {
    title: "Trend's",
    avatarUrl:
    ...
    query: "/EcoVibe/Explore-Products/tags=trend",
  },
];
          ...
          >
            ...
            <div className="w-full h-full rounded-md flex bg-primary-500/45 flex-col items-center justify-evenly px-4 py-2 gap-2">
              ...
              <button
                ...
                className="text-primary-950 px-2 p-1 rounded-md bg-primary-50 hover:bg-primary-950 hover:text-white transition-all"
              >
                Show More
              </button>
            </div>
